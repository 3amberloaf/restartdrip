...
a=""+X(a.h,"host")+("/embed/"+X(a.h,"videoId"))+"?"+Tb(f);od.yt_embedsEnableIframeSrcWithIntent?(Fb(c,yb(a)),c.sandbox.add("allow-presentation","allow-top-navigation")):c.src=a;return c}
